...
# 원하는 주관기관만 뽑기
last_year_data = last_year_data[last_year_data['교육 명'].str.contains('앱|안드로이드|ios|스위프트|swift')]
...
st.set_page_config(
    page_title="🗓️2023년 앱 관련 교육🗓️",
    page_icon="⭐",
    layout="wide")

st.sidebar.header("4️⃣2023년 앱 관련 교육")
